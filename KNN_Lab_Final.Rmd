...
kNN_res = table(tv_3NN,
                tv_data_test$label)
kNN_res # Initial Confusion Matrix
...
# The accuracy is 76.76%, the Sensitivity is 86.73%, and the Specificity is 59%. Based on Mr. Rooney's goal, we should probably choose a specificity that is low. 
```
